...
pixi add libcufft libcufft-dev libcufft-static
# for installing globally
pixi global install libcufft libcufft-dev libcufft-static
```
...
It is possible to list all of the versions of `libcufft` available on your platform:
...
```
pixi search libcufft --channel conda-forge
```
